...
@Component({
  selector: 'app-user-glossy',
  templateUrl: './user-glossy.component.html',
  styleUrl: './user-glossy.component.css'
})
export class UserGlossyComponent implements AfterViewInit{
